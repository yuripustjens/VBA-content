...
The  **PresetTexture** property value can be one of the ** [MsoPresetTexture](http://msdn.microsoft.com/library/msopresettexture-enumeration-office%28Office.15%29.aspx)** constants declared in the Microsoft Office type library.
