...
The Type parmater can be one of the  ** [MsoFileDialogType](http://msdn.microsoft.com/library/msofiledialogtype-enumeration%28Office.15%29.aspx)** constants declared in the Microsoft Office type library.
