...
The  **EndArrowheadLenght** property value can be one of the ** [MsoArrowheadLength](http://msdn.microsoft.com/library/msoarrowheadlength-enumeration-office%28Office.15%29.aspx)** constants declared in the Microsoft Office type library.
