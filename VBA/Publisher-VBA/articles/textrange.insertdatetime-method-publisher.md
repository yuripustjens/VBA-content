...
The Language parameter can be one of the  ** [MsoLanguageID](http://msdn.microsoft.com/library/msolanguageid-enumeration-office%28Office.15%29.aspx)** constants declared in the Microsoft Office type library.
