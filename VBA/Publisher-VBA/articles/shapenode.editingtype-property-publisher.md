...
The  **EditingType** property value can be one of the ** [MsoEditingType](http://msdn.microsoft.com/library/msoeditingtype-enumeration-office%28Office.15%29.aspx)** constants declared in the Microsoft Office type library.
