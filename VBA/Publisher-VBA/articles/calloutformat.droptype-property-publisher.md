...
The  **DropType** property value can be one of the ** [MsoCalloutDropType](http://msdn.microsoft.com/library/msocalloutdroptype-enumeration-office%28Office.15%29.aspx)** constants declared in the Microsoft Office type library.
